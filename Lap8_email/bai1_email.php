<?php
          ...
          $mail = new PHPMailer\PHPMailer\PHPMailer(true);  //true: enables exceptions
            try {
               // $mail->SMTPDebug = 2;  // 0,1,2: chế độ debug. khi mọi cấu hình đều tớt thì chỉnh lại 0 nhé
                ...
                $nguoigui = 'danhhn.24ite@vku.udn.vn';
                $matkhau = 'ggbb iuhm igsw zgpb';// mật khẩu của tài khoản ngolequanvh@gmail.com
                $tennguoigui = 'Danh';
                ...
                $to = "huynhdanh21122006@gmail.com";
                $to_name = "Nhân";
    ...
    $email_array = explode(",",$recipients);*/
                ...
                $mail->Subject = 'Hello bạn từ PHP Mailer';      
                $noidungthu = "<b>Chào bạn toi la Danh, Chúc suc khoe gap nhieu may man!" ;
